...
function evalScript(scriptName, callback) {
...
function currentSlideText() {
  var sl = Slides.findOne({ind:currentSlide()});
  if (! sl) {
    return "Loading";
  } else {
    return sl.text;
...
// Template.reveal.ind = function () {
//   console.log("computing rvl index");
//   var out = Session.get('panelIndex');
//   Session.set('panelIndex',out+1);
//   return "rvl"+out;
// }

// Template.reveal_panels.helpers(Slides.findOne({ind:currentSlide()}));
// Template.reveal_panels.text = function () {
//   return Slides.findOne({ind:currentSlide()}).text;
// }
...
function revealRendered() {
  ...
  */
  //console.log(Reveal);
  //evalScript('/lib/js/reveal.js', function (){
  //});
